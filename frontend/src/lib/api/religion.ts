...
export class ReligionAPI {
	static async getAllReligions(): Promise<Religion[]> {
		try {
	...
	static async getCastesByReligionId(religionId: string): Promise<Caste[]> {
		try {
	...
	static async getAllReligionsWithCastes(): Promise<ReligionCasteMapping[]> {
		try {
